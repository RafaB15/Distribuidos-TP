...
func main() {
	file1 := flag.String("file1", "", "Ruta al primer archivo de resultados")
	file2 := flag.String("file2", "", "Ruta al segundo archivo de resultados")
	flag.Parse()

	if *file1 == "" || *file2 == "" {
		fmt.Println("Por favor, especifica ambos archivos usando --file1 y --file2.")
		return
	}

	err := compareQueries(*file1, *file2)
	if err != nil {
...
// Para correrlo:
// go run ./scripts/compare_results/compare_results.go --file1=ruta_del_cliente.txt --file2=ruta_de_resultados.txt

// Ejemplo de uso:
// go run ./scripts/compare_results/compare_results.go --file1=./cmd/client/client_data/client_4_results.txt --file2=results500k.txt
